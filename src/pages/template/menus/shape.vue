        ...
        <mu-list-item :title="getTitle()" @click.stop="open" :open="data.selected && !data.islocked">
            ...
            <mu-list-item v-if="hasGradient()" slot="nested" class="paddingZero demiBlackbg" v-no-ripple>
             ...
             <mu-list-item v-if="hasGradient()" slot="nested" class="paddingZero demiBlackbg" v-no-ripple>
              <div class="gridlist-demo-container" style="margin-top: -6px;">
                ...
                <input :disabled="!data.attributes.isGradient" style="cursor: pointer" id="gradcolour" @click="showPicker($event,'gradient')" spellcheck="false" class="input-size sliderInput" :style="{backgroundColor:selectedGradientColor, border: 'thin ' + invertColor(selectedGradientColor) + ' solid'}" >
                </mu-grid-list>
              </div>
            ...
            <mu-list-item :disabled="!hasBorder()" slot="nested" class="paddingZero demiBlackbg" v-no-ripple>
              <div class="gridlist-demo-container" style="margin-top: -6px;">
                ...
                <input :disabled="!hasBorder()"  spellcheck="false" class="input-size sliderInput" :style="{backgroundColor:data.attributes.borderColor, border: 'thin ' + invertColor(data.attributes.borderColor) + ' solid'}" @click="showPicker($event,'border')">
                </mu-grid-list>
              </div>
            ...
            <mu-list-item v-if="anim.animation === 'Rotate'" slot="nested" class="paddingZero demiBlackbg" v-no-ripple>
              <div class="gridlist-demo-container">
                ...
                <mu-slider @mouseover.native="createPreview(anim, 'start')" @mouseout.native="removePreview()" @input="createPreview(anim, 'start')" v-model="anim.start" :min="-360" :max="360" class="mmslider" :step="0.1"/>
            ...
            <mu-list-item v-if="anim.animation === 'Rotate'" slot="nested" class="paddingZero demiBlackbg" v-no-ripple>
              <div class="gridlist-demo-container">
                ...
                <mu-grid-list class="right" style="padding-top: 5px;">
                <mu-slider @mouseover.native="createPreview(anim, 'end')" @mouseout.native="removePreview()" @input="createPreview(anim, 'end')" v-model="anim.end" :min="-360" :max="360" class="mmslider" :step="0.1"/>
